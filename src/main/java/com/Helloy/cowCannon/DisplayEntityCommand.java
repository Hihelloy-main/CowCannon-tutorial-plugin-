...
public final class DisplayEntityCommand implements CommandExecutor, TabExecutor {
    ...
    public boolean onCommand( CommandSender sender,  Command command,  String s,  String[] strings) {
        ...
        try {
            ...
            sender.sendMessage("Error: " + t.getMessage().toUpperCase());

...
public class PsychoMob1_20 extends SnowGolem {

	public PsychoMob1_20(Location loc) {
		...
		this.getBukkitEntity().setMetadata("DeadlySnowman", new FixedMetadataValue(CowCannon.getPlugin(), true));
